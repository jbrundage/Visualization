import { Area, Bar, Bubble, Column, Contour, HexBin, Line, Pie, Radar, RadialBar, Scatter, StatChart, Step, WordCloud } from "@hpcc-js/chart";
...
export type VizType = "Table" | "FieldForm" |
    ...
    "EntityRectList" | "AdjacencyGraph" | "StatChart";

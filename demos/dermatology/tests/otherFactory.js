    ...
    return {
        ...
        Table: {
            ...
            widget: function (callback) {
                legacyRequire(["test/DataFactory", "src/other/Table", "src/form/CheckBox", "src/chart/Column"], function (DataFactory, Table, CheckBox, Column) {
                    callback(new Table()
        ...
        NestedTable: {
            simple: function (callback) {
                legacyRequire(["test/DataFactory", "src/other/NestedTable"], function (DataFactory, NestedTable) {
        ...
        Toolbar: {
            simple: function (callback) {
                legacyRequire(["test/DataFactory", "src/composite/MegaChart", "src/form/Select"], function (DataFactory, MegaChart, Select) {
        ...
        Legend: {
            simple: function (callback) {
                legacyRequire(["test/DataFactory", "src/layout/Border", "src/chart/Line", "src/other/Legend"], function (DataFactory, Border, Line, Legend) {
                    var line = new Line()
        ...
        Html: {
            simple: function (callback) {
                legacyRequire(["src/other/Html"], function (Html) {
                    var w = new Html();
        ...
        AutoCompleteText: {
            simple: function (callback) {
                legacyRequire(["src/other/AutoCompleteText", "test/DataFactory"], function (AutoCompleteText, DataFactory) {
        ...
        Select: {
            simple: function (callback) {
                legacyRequire(["src/other/Select"], function (Select) {
                    callback(new Select()
                        .columns(["Col Label", "Col Value"])
                        .data([
                            ["Math", 0],
        ...
        RadioCheckbox: {
            simple: function (callback) {
                legacyRequire(["src/other/RadioCheckbox"], function (RadioCheckbox) {
        ...
        CalendarHeatMap: {
            simple: function (callback) {
                legacyRequire(["test/DataFactory", "src/other/CalendarHeatMap"], function (DataFactory, CalendarHeatMap) {

...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./samples.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var samples_js_1 = require("./samples.js");
    var testPath = decodeURIComponent(window.location.search.split("?")[1]);
    if (testPath) {
        loadPath(testPath);
    }
    else {
    ...
    function loadAllPaths() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                for (_i = 0, sampleFiles_1 = samples_js_1.sampleFiles; _i < sampleFiles_1.length; _i++) {

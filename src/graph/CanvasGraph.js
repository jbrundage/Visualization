...
(function (root, factory) {
    ...
    CanvasGraph.prototype.Vertex = Vertex;
    CanvasGraph.prototype.Edge = Edge;

    CanvasGraph.prototype._palette = Palette.rainbow("default");
    CanvasGraph.prototype._class += " graph_CanvasGraph";

    /* Backwards compatibility for SVG Graph params */
    CanvasGraph.prototype.publish("allowDragging", true, "boolean", "Allow Dragging of Vertices", null, { tags: ["Advanced"] });
    //CanvasGraph.prototype.publish("layout", "Circle", "set", "Default Layout", ["Circle", "ForceDirected", "ForceDirected2", "Hierarchy", "None"], { tags: ["Basic"] });
    CanvasGraph.prototype.publish("scale", "100%", "set", "Zoom Level", ["all", "width", "selection", "100%", "90%", "75%", "50%", "25%", "10%"], { tags: ["Basic"] });
    CanvasGraph.prototype.publish("applyScaleOnLayout", false, "boolean", "Shrink to fit on Layout", null, { tags: ["Basic"] });
    CanvasGraph.prototype.publish("highlightOnMouseOverVertex", false, "boolean", "Highlight Vertex on Mouse Over", null, { tags: ["Basic"] });
    CanvasGraph.prototype.publish("highlightOnMouseOverEdge", false, "boolean", "Highlight Edge on Mouse Over", null, { tags: ["Basic"] });
    CanvasGraph.prototype.publish("transitionDuration", 250, "number", "Transition Duration", null, { tags: ["Intermediate"] });
    ...
    CanvasGraph.prototype.publish("forceDirectedCharge", -25, "number", "Charge strength ", null, { tags: ["Advanced"] });
    CanvasGraph.prototype.publish("forceDirectedChargeDistance", 10000, "number", "Maximum distance over which charge forces are applied", null, { tags: ["Advanced"] });
    CanvasGraph.prototype.publish("forceDirectedTheta", 0.8, "number", "Barnes–Hut approximation criterion", null, { tags: ["Advanced"] });
    CanvasGraph.prototype.publish("forceDirectedGravity", 0.1, "number", "Gravitational strength", null, { tags: ["Advanced"] });

    CanvasGraph.prototype.publish("annotation_tooltip_map", {}, "object", "annotation_tooltip_map", null, { tags: ["Advanced"] });
    ...
    CanvasGraph.prototype.publish("debug_line_intersections", false, "boolean", "debug_line_intersections", null, { tags: ["Basic"] });
    ...
    CanvasGraph.prototype.publish("hierarchyNodeSeparation", 50, "number", "hierarchyNodeSeparation", null, { tags: ["Basic"] });
    ...
    CanvasGraph.prototype.publish("line_fill_color", "#9bcbeb", "string", "line_fill_color", null, { tags: ["Basic"] });
    CanvasGraph.prototype.publish("line_stroke_color", "#9bcbeb", "string", "line_stroke_color", null, { tags: ["Basic"] });
    ...
    CanvasGraph.prototype.publish("find_line_intersections", false, "boolean", "find_line_intersections", null, { tags: ["Basic"] });

    /* VERTEX params */
    CanvasGraph.prototype.publish("enable_node_collapse", true, "boolean", "enable_node_collapse", null, { tags: ["Basic"] });
    CanvasGraph.prototype.publish("enable_annotation_tooltips", true, "boolean", "enable_annotation_tooltips", null, { tags: ["Basic"] });
    ...
    CanvasGraph.prototype.publish("auto_primary_threshold", 0, "number", "auto_primary_threshold", null, { tags: ["Basic"] });
    ...
    CanvasGraph.prototype.publish("vertex_preset", true, "boolean", "vertex_preset", null, { tags: ["Basic"] });//<---- refactor this concept
    CanvasGraph.prototype.publish("width", 35, "number", "width", null, { tags: ["Basic"] });
    CanvasGraph.prototype.publish("height", 35, "number", "height", null, { tags: ["Basic"] });
    ...
    CanvasGraph.prototype.publish("annotation_size", 14, "number", "annotation_size", null, { tags: ["Basic"] });
    CanvasGraph.prototype.publish("node_stroke_width", 0.5, "number", "node_stroke_width", null, { tags: ["Basic"] });
    CanvasGraph.prototype.publish("is_circle_icon", false, "boolean", "is_circle_icon", null, { tags: ["Basic"] });
    ...
    CanvasGraph.prototype.icon_fill = function (d) {
        ...
        else if (d.icon_color || d.icon_fill)
            return d.icon_color ? d.icon_color : d.icon_fill;
    ...
    CanvasGraph.prototype.icon_stroke = function (d) {
        ...
        else if (d.icon_stroke)
            return d.icon_stroke;
        else if (d.is_primary)
    ...
    CanvasGraph.prototype.container_fill = function (d) {
        ...
        else if (d.container_fill)
            return d.container_fill;
        else if (d.is_primary)
    ...
    CanvasGraph.prototype.container_stroke = function (d) {
        ...
        else if (d.container_stroke)
            return d.container_stroke;
        else if (d.is_primary)
    ...
    CanvasGraph.prototype.label_stroke = function (d) {
        ...
        else if (d.label_stroke)
            return d.label_stroke;
        else if (d.is_primary)
    ...
    CanvasGraph.prototype.labelbg_fill = function (d) {
        ...
        else if (d.labelbg_fill)
            return d.labelbg_fill;
        else if (d.is_primary)
    ...
    CanvasGraph.prototype.labelbg_stroke = function (d) {
        ...
        else if (d.labelbg_stroke)
            return d.labelbg_stroke;
        else if (d.is_primary)
     ...
     * {"nodes":[
     *         {
     *             "data_type":"Focus","icon_color":"#ef2330","uid":"_47905196417","label":"foobar","icon":"",
     *             "child_arr":["_10022BOYNTONPLACECIRAPT424"],
     *             "parent_arr":[]
     *         },
     *         {
     *             "data_type":"Normal","icon_color":"#fd720b","uid":"_10022BOYNTONPLACECIRAPT424","label":"foobar","icon":"",
     *             "child_arr":[],
     *             "parent_arr":["_47905196417"]
     *         },
     *         {
     *             "data_type":"Focus","icon_color":"#ef2330","uid":"_308759694","label":"foobar","icon":"",
     *             "child_arr":[],
     *             "parent_arr":[]
     *         },
     *         {
     *             "data_type":"Focus","icon_color":"#ef2330","uid":"_308593134","label":"foobar","icon":"",
     *             "child_arr":[],
     *             "parent_arr":[]
     *         }
     *     ],
     ...
     *     {
     *         "source":"_47905196417",
     *         "target":"_10022BOYNTONPLACECIRAPT424"
     *     }
     * ]}
     */
    CanvasGraph.prototype.vertices_to_nodes = function (domNode, element) {
        var nodes = [];
        if ("undefined" !== typeof this.data().vertices) {
            /*
    CanvasGraph.prototype.icon_fill
    CanvasGraph.prototype.icon_stroke
    CanvasGraph.prototype.container_fill
    CanvasGraph.prototype.container_stroke
    CanvasGraph.prototype.label_fill
    CanvasGraph.prototype.label_stroke
    CanvasGraph.prototype.labelbg_fill
    CanvasGraph.prototype.labelbg_stroke
     */
            this.data().vertices.forEach(function (vertex, i) {
                var annotation_arr = vertex.annotationIcons().map(function (anno) {
                    console.info("anno.faChar:", anno.faChar);
                    return {
                        "icon": anno.faChar,
                        "fill": anno.shape_colorFill,
                        "stroke": anno.shape_colorStroke,
                        "icon_fill": "#ffffff",
                        "icon_stroke": "transparent",
                    };
                });
                nodes.push({
                    "label": vertex.text(),
                    "icon": vertex._icon._faChar.char(),
                    "uid": i,
                    "index": i,
                    "annotations": annotation_arr,
                    "icon_fill": '#ffffff',
                    "icon_stroke": 'transparent',
                    "container_fill": vertex.icon_shape_colorFill() ? vertex.icon_shape_colorFill() : '#1f77b4',
                    "container_stroke": vertex.icon_shape_colorStroke() ? vertex.icon_shape_colorStroke() : '#1f77b4',
                    "label_fill": vertex.textbox_text_colorFill(),
                    "label_stroke": "transparent",
                    "labelbg_fill": vertex.textbox_shape_colorFill() ? vertex.textbox_shape_colorFill() : '#dcf1ff',
                    "labelbg_stroke": vertex.textbox_shape_colorStroke() ? vertex.textbox_shape_colorStroke() : '#1f77b4',
                });
            }, this);
        }
        this.data().nodes = nodes;
    };
    CanvasGraph.prototype.edges_to_links = function (domNode, element) {
        var links = [];
        if ("undefined" !== typeof this.data().edges) {
            this.data().edges.forEach(function (edge) {
                links.push({
                    "source": this.data().vertices.indexOf(edge._sourceVertex),
                    "target": this.data().vertices.indexOf(edge._targetVertex)
                });
            }, this);
        }
    ...
    CanvasGraph.prototype.fix_undefined_data_issue = function () {
        ...
        if (typeof this.data().links === "undefined") {
            this.data().links = [];
        }
    };
        ...
        nodes.forEach(function (d) {
            if (!d.is_hidden) {
                ...
                if (min_y > d.top_edge || typeof (min_y) === "undefined")
                    min_y = d.top_edge;
                if (max_x < d.right_edge || typeof (max_x) === "undefined")
                    max_x = d.right_edge;
                if (max_y < d.bottom_edge || typeof (max_y) === "undefined")
                    max_y = d.bottom_edge;
            }
        });
    ...
    CanvasGraph.prototype.draw = function () {
        ...
        if (this.find_line_intersections() && (this.layout() === 'ForceDirected' || this.layout() === 'ForceDirected2')) {
            if (this.draw_count % 10) find_link_intersections.call(this);
        }
    ...
    CanvasGraph.prototype.draw_geocache_grid = function () {
        ...
        for (var x = 0 - col_count / 2; x < col_count / 2; x++)cell_x_arr.push(gc_w * x);
        for (var y = 0 - row_count / 2; y < row_count / 2; y++)cell_y_arr.push(gc_h * y);
        ...
        var x_offset = this.x_transform * this.k_transform;
        var y_offset = this.y_transform * this.k_transform;
    ...
    CanvasGraph.prototype.resize = function () {
        ...
        if (this.data().nodes && this.data().nodes.length > 0 && this.data().info) {
            this.zoom_to_fit(0);
            this.draw();
        }
        return retVal;
    ...
    CanvasGraph.prototype.drawNode = function (d, i) {
        ...
        d.poly = [];
        d.anno_poly = [];
        d.left_edge = typeof d.x !== "undefined" ? d.x : 0;
        d.right_edge = typeof d.x !== "undefined" ? d.x : 0;
        d.top_edge = typeof d.y !== "undefined" ? d.y : 0;
        d.bottom_edge = typeof d.y !== "undefined" ? d.y : 0;
        ...
        function drawNodeLabel() {
            ...
            var _sw = context.node_stroke_width();
            ...
            if (context && context.transform && _txt_h * context.transform.k > 3) {
                drawNodeLabelText();
            } else {
                drawFauxLabelText();
            }
            ...
            function drawFauxLabelText() {
                context.ctx.strokeStyle = context.labelbg_stroke(d);
                context.ctx.fillStyle = context.labelbg_stroke(d);
                var __x1 = _x1 + _p;
                var __y1 = _y1;
                context.ctx.beginPath();
                context.ctx.rect(__x1, __y1 - (_txt_h / 2), _txt_w, _txt_h);
                context.ctx.fill();
                context.ctx.stroke();
                context.ctx.closePath();
            }
        ...
        function drawNodeAnnotations() {
            ...
            function drawNodeAnnotation(o, i) {
                ...
                if (typeof d.anno_tip_idx !== "undefined" && d.anno_tip_idx === i) {
                    drawNodeAnnotationTooltip();
                }
                ...
                function drawNodeAnnotationIcon() {
                    ...
                    context.ctx.beginPath();
                    context.ctx.strokeStyle = o.icon_stroke ? o.icon_stroke : context.annotation_icon_fill();
                    context.ctx.fillStyle = o.icon_fill ? o.icon_fill : context.annotation_icon_stroke();
                    context.ctx.fillText(_anno_txt, __x1, __y1 + (_p / 2));
                    context.ctx.closePath();
                }
                function drawNodeAnnotationTooltip() {
                    context.ctx.font = _anno_h + "px 'Helvetica'";
                    var _tooltip_text = '';

                    if (typeof d.annotations[d.anno_tip_idx] !== "undefined") {
                        if (typeof d.anno_poly[d.anno_tip_idx] !== "undefined") {
                            var _color = d.annotations[d.anno_tip_idx].color ? d.annotations[d.anno_tip_idx].color : d.annotations[d.anno_tip_idx].fill;
                            if (!_color) {
                                _color = d.annotations[d.anno_tip_idx].stroke;
                            }
                            var anno_tooltip_map_key = d.annotations[d.anno_tip_idx].icon + '__' + standardize_color(_color);
                            if (typeof context.annotation_tooltip_map()[anno_tooltip_map_key] !== "undefined") {
                                var annotation_poly = d.anno_poly[d.anno_tip_idx];
                                var _tooltip_text = context.annotation_tooltip_map()[anno_tooltip_map_key].description;

                                var _tooltip_text_size = context.getMeasuredText(_tooltip_text);

                                drawNodeAnnotationTooltipBackground();
                                drawNodeAnnotationTooltipText();
                            }
                        }
                    }
                    function drawNodeAnnotationTooltipText() {
                        var __x1 = annotation_poly.poly[0][0];
                        var __y1 = annotation_poly.poly[0][1];
                        __x1 += anno_w / 2;
                        __x1 += _p * 2;
                        __x1 -= (_tooltip_text_size.width + (_p * 2)) / 2;
                        __y1 += anno_h;
                        __y1 += _anno_h + _p;
                        __y1 -= _p;
                        context.ctx.beginPath();
                        context.ctx.strokeStyle = o.icon_stroke ? o.icon_stroke : context.annotation_icon_fill();
                        context.ctx.fillStyle = o.icon_fill ? o.icon_fill : context.annotation_icon_stroke();
                        context.ctx.fillText(_tooltip_text, __x1, __y1 + (_p / 2));
                        context.ctx.closePath();
                    }
                    function drawNodeAnnotationTooltipBackground() {
                        var __x1 = annotation_poly.poly[0][0];
                        var __y1 = annotation_poly.poly[0][1];
                        __x1 += anno_w / 2;
                        __x1 -= _tooltip_text_size.width / 2;
                        __y1 += anno_h;
                        context.ctx.beginPath();
                        context.ctx.rect(__x1, __y1, _tooltip_text_size.width + (_p * 2), _anno_h + (_p * 2));
        ...
        d3.select(this.canvas)
            ...
            .on("click", function () {
                ...
                if (clicked_node) {
                    ...
                    context.vertex_click(context.rowToObj(original_vertex.data()), col, is_selected, vertex_obj);
                }
            })
            .on("dblclick", function () {
                ...
                if (clicked_node) {
                    ...
                    context.vertex_dblclick(context.rowToObj(original_vertex.data()), col, is_selected, vertex_obj);
                }
            })
            ;
    ...
    CanvasGraph.prototype.canvas_mousemove = function () {
        ...
        for (i = this.data().nodes.length - 1; i >= 0; --i) {
            ...
            if (node.is_selected || _is_inside_node_poly) {
                ...
                if (_is_inside_node_poly) {
                    ...
                    if (this.enable_annotation_tooltips()) {
                        set_anno_tip_idx(node);
                    }
                } else {
        ...
        function set_anno_tip_idx(node) {
            var idx;
            node.anno_poly.forEach(function (a_poly, anno_idx) {
                var is_in_poly = context.inside_poly([x, y], a_poly.poly, context.transform);
                if (is_in_poly) {
                    idx = anno_idx;
                }
            });
            if (typeof idx !== "undefined") {
                node.anno_tip_idx = idx;
            } else if (typeof node.anno_tip_idx !== "undefined") {
                delete node.anno_tip_idx;
            }
        }
    }

...
//                    _node.x = Math.cos(angle) * _radius;
//                    _node.y = Math.sin(angle) * _radius;
        ...
        "CircleHierarchy": {
            ...
            init: function (data) {
                ...
                if(typeof node_positions[0] === "undefined")return;
                var uni_x = [];
                var uni_y = [];
                ...
                //console.info("node_positions:", node_positions);
                ...
                if(["LR","RL"].indexOf(this.hierarchyRankDirection()) !== -1){
                    uni_x.forEach(function (x) {
                        ...
                        circle_map_radius[x] = _x_ratio * this.circle_layout_radius();
                    }, this);
                    ...
                    uni_y.forEach(function (y) {
                        ...
                        circle_map_radius[y] = _y_ratio * this.circle_layout_radius();
                    }, this);
                }
                node_positions.forEach(function (_pos, _idx) {
                    var _node = data.nodes[_idx];
                    _node.force_x = Math.cos(circle_map_angle[_pos.x]) * circle_map_radius[_pos.y];
                    _node.force_y = Math.sin(circle_map_angle[_pos.x]) * circle_map_radius[_pos.y];
                });
            }
        },
        "ForceDirected": {

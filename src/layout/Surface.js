...
(function (root, factory) {
   ...
   Surface.prototype.publish("surfaceTitlePadding", 0, "number", "Title Padding (px)", null, { tags: ["Advanced"] });
   ...
   Surface.prototype.publish("surfacePadding", 0, "string", "Surface Padding (px)", null, { tags: ["Intermediate"] });
   Surface.prototype.publish("surfaceBackgroundColor", "#000", "html-color", "Surface Background Color", null, { tags: ["Advanced"] });
   Surface.prototype.publish("surfaceBorderWidth", 0, "number", "Surface Border Width (px)", null, { tags: ["Advanced"] });
   Surface.prototype.publish("surfaceBorderColor", "#000", "html-color", "Surface Border Color", null, { tags: ["Advanced"] });
   Surface.prototype.publish("surfaceBorderRadius", 0, "number", "Surface Border Radius (px)", null, { tags: ["Advanced"] });

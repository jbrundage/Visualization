...
(function (root, factory) {
    ...
    var DataFactory = {
        ...
        Graph: {
            simple: {
                nodes: [
                  { "name": "Mark Marsupial", "group": 1 },
                  
                  { "name": "918 Pompano Dr.\n Jupiter, FL 33453", "group": 1 },
                  { "name": "6789 Mainstreet\n Anytown, FL 22222", "group": 1 },
                  { "name": "456 Mainstreet\n Anytown, FL 22222", "group": 1 },
                  
                  { "name": "White Honda", "group": 2 },
                  
                  { "name": "Bob Marsupial", "group": 3 },
                  { "name": "Megan Marsupial", "group": 1 },
                  { "name": "Jane Smith", "group": 3 },
                  { "name": "Bill Smith", "group": 3 },
                  { "name": "John Doe", "group": 3 },
                  { "name": "Marie Doe", "group": 3 },
                ],
                "links": [

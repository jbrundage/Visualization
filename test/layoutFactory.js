    ...
    return {
        AbsoluteSurface: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/layout/AbsoluteSurface", "src/chart/Column"], function (DataFactory, AbsoluteSurface, Column) {
        ...
        Accordion: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/layout/Accordion", "src/other/Table", "src/layout/Surface", "src/chart/MultiChart", "src/chart/Line", "src/chart/Column"], function (DataFactory, Accordion, Table, Surface, MultiChart, Line, Column) {
                    callback(
                        new Accordion()
        ...
        Cell: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/layout/Cell", "src/chart/Line"], function (DataFactory, Cell, Line) {
                    callback(new Cell()
                        .title(DataFactory.Surface.simple.title)
                        .widget(new Line()
                            .columns(DataFactory.ND.subjects.columns)
        ...
        Grid: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/layout/Grid", "src/chart/Pie", "src/chart/MultiChartSurface", "src/chart/Line", "src/chart/Column", "src/chart/Step"], function (DataFactory, Grid, Pie, MultiChartSurface, Line, Column, Step) {
                    callback(new Grid()
            ...
            hoverIndicator: function (callback) {
                es6Require(["test/DataFactory", "src/layout/Grid", "src/chart/Pie", "src/chart/Step"], function (DataFactory, Grid, Pie, Step) {
                    var pie1 = new Pie()
                        .columns(DataFactory.TwoD.subjects.columns)
                        .data(DataFactory.TwoD.subjects.data)
                        ;
            ...
            complex: function (callback) {
                es6Require(["test/DataFactory", "src/layout/Grid", "src/chart/Pie", "src/chart/Area", "src/chart/Line", "src/other/Table", "src/map/GMap"], function (DataFactory, Grid, Pie, Area, Line, Table, GMap) {
            ...
            hugeTables: function (callback) {
                es6Require(["test/DataFactory", "src/layout/Grid", "src/other/Table"], function (DataFactory, Grid, Table) {
                    var colCount = 10;
                    var rowCount = 1000;
        ...
        Layered: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/layout/Layered", "src/layout/AbsoluteSurface", "src/chart/Pie", "src/chart/MultiChartSurface", "src/chart/Line", "src/chart/Column", "src/chart/Step"], function (DataFactory, Layered, AbsoluteSurface, Pie, MultiChartSurface, Line, Column, Step) {
        ...
        Popup: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/layout/Popup", "src/layout/Surface", "src/common/Icon"], function (DataFactory, Popup, Surface, Icon) {
            ...
            shrink: function (callback) {
                es6Require(["test/DataFactory", "src/layout/Popup", "src/layout/Surface", "src/other/Table"], function (DataFactory, Popup, Surface, Table) {
                    var retVal = new Popup();
            ...
            shrink2: function (callback) {
                es6Require(["test/DataFactory", "src/layout/Popup", "src/layout/Surface", "src/chart/Line"], function (DataFactory, Popup, Surface, Line) {
                    var retVal = new Popup();
        ...
        Surface: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/layout/Surface", "src/chart/Line"], function (DataFactory, Surface, Line) {
        ...
        Tabbed: {
            simple: function (callback) {
                es6Require(["test/DataFactory", "src/layout/Tabbed", "src/chart/Pie", "src/chart/MultiChartSurface", "src/chart/Line", "src/chart/Column", "src/chart/Step"], function (DataFactory, Tabbed, Pie, MultiChartSurface, Line, Column, Step) {
                    callback(new Tabbed()
                        .addTab(
                        new Pie()
                            .columns(DataFactory.TwoD.subjects.columns)
